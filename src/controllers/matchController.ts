...
const getMatchesPage = async ({ limit, offset }: { limit: number, offset: number }): Promise<Match[]> => {
  const query = `
    SELECT
      ...
      guest_team as guestTeam, guest_captain as guestCaptain,
      guest_pos1 as guestPos1, guest_pos2 as guestPos2, guest_pos3 as guestPos3, guest_pos4 as guestPos4,
      guest_pos5 as guestPos5, guest_pos6 as guestPos6, guest_pos7 as guestPos7, guest_pos8 as guestPos8,
